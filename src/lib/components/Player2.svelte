...
<main class="flex justify-between h-full">
	...
	<section class="flex flex-col w-24">
		...
		<div class="flex flex-auto justify-center">
			<div class="flex flex-col my-auto">
				<p class="flex transform rotate-90 text-gray-400 font-nhaasbd ">1</p>
				<p class="flex font-nhaasbd text-2xl transform rotate-90">
					{gum}
				</p>
			</div>
		</div>
		...
		<div class="flex flex-auto ">
			<div class="flex flex-col my-auto">
				<p class="flex ml-[-6.4rem] mb-[-0.6rem] transform rotate-90 text-gray-400 font-nhaasbd">
					2
				</p>
				<p class="flex font-nhaasbd text-2xl transform rotate-90 w-72 ml-[-6.2rem]">
					{swimmingLessons}
				</p>
			</div>
		</div>
	...
	<!-- ////////// Middle Column ////////// -->
	<section class="grow w-20 flex-col my-auto">
		<!-- Buttons Container -->
	...
	<!-- ////////// Right Column ////////// -->
	<section class="flex flex-col w-24 border border-white">
		<p>test</p>
		<div class="flex mr-9 h-20 w-0.5 mt-[-4rem] bg-gray-400" />
		<!-- Minutes Container -->
